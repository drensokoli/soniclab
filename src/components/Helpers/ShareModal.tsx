...
export default function ShareModal({ setOpen, shareUrl }: { setOpen: any, shareUrl: string }) {
    ...
    function encodeURIComponentCustom(text: string) {
    ...
    return (
        <div className="w-full bg-white shadow-lg rounded-md p-6 relative">
            <div className="flex items-center pb-3 border-b">
                <h3 className="text-xl font-medium flex-1">Share SonicLab</h3>
            ...
            <div className="my-8">
                <div className="flex items-center justify-center space-x-6 mt-6 text-center">
                    ...
                    {/* FACEBOOK */}
                    <button type="button"
                        onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&t=Lyrafy`, '_blank')}
                    ...
                    {/* TWITTER */}
                    <button type="button"
                        onClick={() => window.open(`https://twitter.com/intent/tweet?text=I'm%20using%20Lyrafy%20to%20create%20monthly%20playlists%20with%20my%20top%20songs%20%F0%9F%8E%B6&url=${shareUrl}`, '_blank')}
                    ...
                    {/* REDDIT */}
                    <button type="button"
                        onClick={() => window.open(`https://reddit.com/submit?url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent("I'm using Lyrafy to create monthly playlists with my top songs 🎶 ")}`, '_blank')}
                        className="sm:w-12 sm:h-12 w-8 h-8 inline-flex items-center justify-center rounded-full border-none outline-none hover:shadow-xl"
