...
export default function RecommendSongs({ fetchRecommendation, fetchingRecommendation }: { fetchRecommendation: any, fetchingRecommendation: boolean }) {
    ...
    return (
        ...
        >
            {fetchingRecommendation ? (
                <img src="./loading.png" alt="Add more songs" width={40} height={40} className="mt-4" />
            ) : (
