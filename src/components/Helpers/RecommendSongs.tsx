...
export default function RecommendSongs({fetchRecommendation}: {fetchRecommendation: any}) {
    ...
    return (
        <div
            className="flex flex-col items-center justify-center gap-2 p-3 border-2 border-[#f33f81] border-opacity-60 backdrop-blur text-gray-200 rounded-md shadow-md dark:bg-gray-800"
