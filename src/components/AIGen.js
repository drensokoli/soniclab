    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='flex flex-row justify-end cursor-pointer text-gray-400 w-full md:w-3/4 pt-4'>
                ...
                <button
                    type="button"
                    className="inline-block rounded border-2 border-neutral-50 px-6 py-2 text-xs font-bold uppercase leading-normal text-gray-300 transition duration-150 ease-in-out hover:bg-gray-300 hover:text-black mb-[120px]"
                    data-te-ripple-init>
                    Generate Playlist
                </button>
            </div>
