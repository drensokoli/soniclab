        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center text-gray-300 py-1">
                <div className="flex flex-row justify-center items-center gap-1">
                    ...
                    <h1 className='text-center text-sm'>We are not related to Spotify AB or any of its partners in any way.</h1>
                </div>
                <h1 className='text-center'>All images are copyrighted by their respective copyright owners.</h1>
            </div>
