        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center text-gray-300 py-1">
                <div className="flex flex-row justify-center items-center gap-1">
                    ...
                    <h1 className='text-sm'>We are not related to Spotify AB or any of it's partners in any way.</h1>
                </div>
                <h1
                    // className="text-sm"
                >All images are copyrighted by their respective copyright owners.</h1>
            </div>
