        ...
        <>
            ...
            <div className="flex flex-row justify-between w-full px-3 py-2">
                <div className="flex flex-row items-start gap-2">
                    ...
                    <select
                        className="bg-gray-200 mt-1 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value={timeRange}
                        onChange={(e) => {
