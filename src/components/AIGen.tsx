    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <textarea id="description" rows={4} className="block p-2.5 w-full md:w-3/4 text-md text-gray-400 bg-transparent rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="The playlist should contain HipHop and R&B songs from the 90s..."></textarea>
